<template>
	<view class="verification-list">
		...
		<view class="operation">
			<view class="operation-button" style="background-color: #FFFFFF;color: #000000;" @click="showInputCode = true">
			...
			<!-- 手动输入核销码MODAL -->
			<u-modal ref="uModalInput" v-model="showInputCode" show-cancel-button
