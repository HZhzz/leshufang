...
let SettingApi = {
  ...
  getAucton(data, errorback){
    return request._get('/shop/setting.auction/index', data, errorback);
  },
  /*竞拍规则设置*/
  setAucton(data, errorback){
    return request._post('/shop/setting.auction/rule', data, errorback);
  },
  /*竞拍规则设置*/
  setAuctonServer(data, errorback){
    return request._post('/shop/setting.auction/setting', data, errorback);
  },

  /*vip会员设置列表*/
  getVipSetting(data,errorback){
    return request._post('/shop/setting.upgrade/index', data, errorback);
  },
  
  /*vip会员设置保存*/
  setVipSetting(data,errorback){
    return request._post('/shop/setting.upgrade/save', data, errorback);
  } 
}
