<template>
    <!--
      ...
      描述：会员-用户列表-会员充值
  -->
    <el-dialog title="会员充值" :visible.sync="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false" :close-on-press-escape="false">
        <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-tab-pane label="充值乐豆" name="third">
                <el-form size="small" :model="form">
                    <el-form-item label="当前乐豆" :label-width="formLabelWidth">
                        <el-input v-model="form.fen" autocomplete="off" disabled="disabled"></el-input>
                    </el-form-item>

                    <el-form-item label="充值方式" :label-width="formLabelWidth">
                        <el-radio-group v-model="recharge.fen.mode">
                            <el-radio label="inc">增加</el-radio>
                            <el-radio label="dec">减少</el-radio>
                        </el-radio-group>
                    </el-form-item>
                    <el-form-item label="变跟数量" :label-width="formLabelWidth">
                        <el-input v-model="recharge.fen.value" autocomplete="off" placeholder="请输入变更数量"></el-input>
                    </el-form-item>
                    <el-form-item label="管理员备注" :label-width="formLabelWidth">
                        <el-input type="textarea" v-model="recharge.fen.remark" placeholder="请输入管理员备注"></el-input>
                    </el-form-item>
                </el-form>
            </el-tab-pane>
        </el-tabs>
