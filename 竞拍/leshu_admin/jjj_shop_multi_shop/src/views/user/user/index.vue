        ...
        <div class="common-seach-wrap">
            <el-form size="small" :inline="true" :model="formInline" class="demo-form-inline">
                ...
                <el-form-item label="会员等级">
                    <el-select v-model="formInline.vip" placeholder="请选择">
        ...
        <div class="product-content">
            <div class="table-wrap">
                <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
                    <el-table-column prop="game_user_id" label="ID" width="80"></el-table-column>
                    ...
                    <el-table-column prop="vip_text" label="会员等级">
                        <!-- <template slot-scope="scope">
                            <span v-if="scope.row.grade_id == 0">无等级</span>
                            <span v-else>{{ scope.row.grade.name }}</span>
                        </template> -->
                    </el-table-column>
                    <el-table-column prop="fen" label="乐豆"></el-table-column>
                    <el-table-column prop="goldcoin" label="金币"></el-table-column>
                    <el-table-column prop="love_price" label="爱心值"></el-table-column>
