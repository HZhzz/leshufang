...
let AuthApi = {
  ...
  roleAddInfo(data, errorback) {
    return request._get('/supplier/auth.role/add', data, errorback);
  },
  /*添加角色*/
  roleAdd(data, errorback) {
    return request._post('/supplier/auth.role/add', data, errorback);
  },
  /*修改角色需要的数据*/
  roleEditInfo(data, errorback) {
    return request._get('/supplier/auth.role/edit', data, errorback);
  },
  /*修改角色*/
  roleEdit(data, errorback) {
    return request._post('/supplier/auth.role/edit', data, errorback);
  },
  /*删除角色*/
  ...
  userList(data, errorback) {
    return request._post('/supplier/auth.user/index', data, errorback);
  },
  /*添加管理员*/
  userAdd(data, errorback) {
    return request._post('/supplier/auth.user/add', data, errorback);
  },
 /*修改管理员需要的数据*/
  userEditInfo(data, errorback) {
    return request._get('/supplier/auth.user/edit', data, errorback);
  },
  /*修改管理员*/
  userEdit(data, errorback) {
    return request._post('/supplier/auth.user/edit', data, errorback);
  },
  /*删除管理员*/
  ...
  loginlog(data, errorback) {
    return request._post('/supplier/auth.loginlog/index', data, errorback);
  },
  /*操作日志*/
  optlog(data, errorback) {
    return request._post('/supplier/auth.optlog/index', data, errorback);
  }
}
