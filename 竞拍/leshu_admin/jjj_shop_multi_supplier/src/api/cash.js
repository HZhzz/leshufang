...
let SupplierApi = {
    ...
    index(data, errorback) {
        return request._get('/supplier/cash.cash/index', data, errorback);
    },
    /*获取用户提现账户信息*/
    ...
    setAccount(data, errorback) {
        return request._post('/supplier/cash.cash/account', data, errorback);
    },
    /*提现记录*/
    lists(data, errorback) {
        return request._post('/supplier/cash.cash/lists', data, errorback);
    },
    /*申请提现*/
    apply(data, errorback) {
        return request._post('/supplier/cash.cash/apply', data, errorback);
    },
    /* 店铺结算*/
    settled(data, errorback) {
        return request._post('/supplier/cash.settled/index', data, errorback);
    },
    /* 店铺结算详情*/
