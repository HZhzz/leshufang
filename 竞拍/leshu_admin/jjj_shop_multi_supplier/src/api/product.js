...
let ProductApi = {
    ...
    catAdd(data, errorback) {
        return request._post('/supplier/product.category/add', data, errorback);
    },
    /*分类删除*/
    ...
    catEdit(data, errorback) {
        return request._post('/supplier/product.category/edit', data, errorback);
    },
    /*产品列表*/
    productList(data, errorback) {
        return request._post('/supplier/product.product/index', data, errorback);
    },
    /*产品选择列表*/
    ...
    addProduct(data, errorback) {
        return request._post('/supplier/product.product/add', data, errorback);
    },
    /*产品基础数据*/
    getBaseData(data, errorback) {
        return request._get('/supplier/product.product/add', data, errorback);
    },
    /*删除产品*/
    ...
    editProduct(data, errorback) {
        return request._post('/supplier/product.product/edit', data, errorback);
    },
    /*新增规格组*/
    ...
    getCommentList(data, errorback) {
        return request._post('/supplier/product.comment/index', data, errorback);
    },
    /*获取评论详情*/
    ...
    editComment(data, errorback) {
        return request._post('/supplier/product.comment/edit', data, errorback);
    },
    /*删除评论*/
