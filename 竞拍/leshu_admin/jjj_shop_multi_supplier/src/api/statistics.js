...
let StatisticsApi = {
  ...
  getOrderByDate(data, errorback) {
    return request._post('/supplier/statistics.sales/order', data, errorback);
  },
  /*商品时间段统计*/
  getProductByDate(data, errorback) {
    return request._post('/supplier/statistics.sales/product', data, errorback);
  },
  /*会员数据统计*/
  ...
  getVisit(data, errorback) {
    return request._post('/supplier/statistics.user/visit', data, errorback);
  },
}
