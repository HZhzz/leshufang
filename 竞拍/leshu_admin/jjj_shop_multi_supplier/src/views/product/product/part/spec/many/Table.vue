    ...
    <div class="mt16">
        <el-form-item label="规格明细：" v-if="form.model.spec_many && form.model.spec_many.spec_list.length > 0">
            <div>
                ...
                <el-input size="small" v-model="batchData.love_price" placeholder="爱心值" style="width: 160px;padding-left: 4px;"></el-input>
                <el-input size="small" v-model="batchData.beans_price" placeholder="乐豆价" style="width: 160px;padding-left: 4px;"></el-input>
            ...
            <div>
                <el-table
                    size="mini"
                    :data="form.model.spec_many.spec_list"
                ...
                >
                    ...
                    <el-table-column label="产品编码">
                        <template slot-scope="scope">
                            <el-form-item label="" style="margin-bottom: 0;"
                                ><el-input size="small" prop="product_no" v-model="scope.row.spec_form.product_no"></el-input
                            ></el-form-item>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="划线价">
                        <template slot-scope="scope">
                            <el-form-item label="" style="margin-bottom: 0;"
                                ><el-input size="small" prop="line_price" v-model="scope.row.spec_form.line_price"></el-input
                            ></el-form-item>
                        </template>
                    </el-table-column> -->
                    <el-table-column label="爱心值">
                        <template slot-scope="scope">
                            <el-form-item
                                label=""
                                :rules="[{ required: true, message: ' ' }]"
                                :prop="'model.spec_many.spec_list.' + scope.$index + '.spec_form.love_price'"
                                style="margin-bottom: 0;"
                            >
                                <el-input size="small" prop="love_price" v-model="scope.row.spec_form.love_price"></el-input>
                            </el-form-item>
                        </template>
                    </el-table-column>
                    <el-table-column label="乐豆价">
                        <template slot-scope="scope">
                            <el-form-item
                                label=""
                                :rules="[{ required: true, message: ' ' }]"
                                :prop="'model.spec_many.spec_list.' + scope.$index + '.spec_form.beans_price'"
                                style="margin-bottom: 0;"
                            >
                                <el-input size="small" prop="beans_price" v-model="scope.row.spec_form.beans_price"></el-input>
                            </el-form-item>
                        </template>
                    </el-table-column>
