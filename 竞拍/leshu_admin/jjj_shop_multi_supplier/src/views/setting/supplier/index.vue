  ...
  -->
    <div>
      ...
      <el-form size="small" ref="formData" :model="formData" label-width="150px">
        <el-form-item label="店铺名称" :rules="[{required: true,message: '请输入店铺名称'}]">
          <el-input v-model="formData.name" placeholder="请输入店铺名称" class="max-w460"></el-input>
        </el-form-item>

        <el-form-item label="联系电话" :rules="[{required: true,message: '请输入联系电话'}]">
          <el-input v-model="formData.link_phone" placeholder="请输入联系电话" class="max-w460" v-bind:readonly="true"></el-input>
        </el-form-item>
        ...
        <el-form-item label="logo" :rules="[{required: true,message: '选择Logo'}]">
          <el-button @click="chooseImg('logo')">选择Logo</el-button>
          <div v-if="formData.logo_id!=''" class="img">
