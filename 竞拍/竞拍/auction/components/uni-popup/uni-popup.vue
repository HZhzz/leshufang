<template>
	<view v-if="showPopup" class="uni-popup">
			<!-- <view v-if="showPopup" class="uni-popup" @touchmove.stop.prevent="moveHandle"> -->
		<view :class="[ani, animation ? 'ani' : '', !custom ? 'uni-custom' : '']" class="uni-popup__mask" @click="close(true)"/>
		<view :class="[type, ani, animation ? 'ani' : '', !custom ? 'uni-custom' : '']" class="uni-popup__wrapper" @click="">
